...
for fold, (train_idx, val_idx) in enumerate(kf.split(df)):
    dftrain,dftest = train_images[train_idx],train_images[val_idx]
    train_target,test_target = train_labels[train_idx],train_labels[val_idx]


    trainloader = get_loader(dftrain,train_target,hyper['Dataloader'],device=device)
